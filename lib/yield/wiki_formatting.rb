  ...
  module WikiFormatting
    ...
    class << self
      ...
      def formatter_for(name)
        ...
        (entry && entry[:formatter]) || Yield::WikiFormatting::NullFormatter::Formatter
      end

      def helper_for(name)
        entry = @@formatters[name.to_s]
        (entry && entry[:helper]) || Yield::WikiFormatting::NullFormatter::Helper
      end
    ...
    module NullFormatter
      class Formatter
        ...
        include Yield::WikiFormatting::LinksHelper
