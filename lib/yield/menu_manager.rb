  ...
  module MenuManager
    ...
    module MenuController
      ...
      def redirect_to_project_menu_item(project, name)
        item = Yield::MenuManager.items(:project_menu).detect {|i| i.name.to_s == name.to_s}
    ...
    module MenuHelper
      ...
      def menu_items_for(menu, project=nil)
        items = []
        Yield::MenuManager.items(menu).root.children.each do |node|
    ...
    class Mapper
      ...
      #   eg. :children => Proc.new {|project| [Yield::MenuManager::MenuItem.new(...)] }
