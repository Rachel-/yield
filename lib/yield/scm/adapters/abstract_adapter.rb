  ...
  module Scm
    module Adapters
      class AbstractAdapter #:nodoc:
        ...
        class << self
          ...
          def shell_quote_command
            if Yield::Platform.mswin? && RUBY_PLATFORM == 'java'
              client_command
            else
      ...
      private
        ...
        def self.stderr_log_file
          if @stderr_log_file.nil?
            writable = false
            path = Yield::Configuration['scm_stderr_log_file'].presence
      ...
      class Entry
        ...
        def is_text?
          Yield::MimeType.is_type?('text', name)
        end
        ...
        def author
          if changeset
            ...
            Yield::CodesetUtil.replace_invalid_utf8(lastrev.author.to_s.split('<').first)
          end
        end
      end
