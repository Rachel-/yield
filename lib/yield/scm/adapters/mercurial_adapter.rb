...
require 'yield/scm/adapters/abstract_adapter'
require 'cgi'
  ...
  module Scm
    module Adapters
      class MercurialAdapter < AbstractAdapter
        ...
        HG_BIN = Yield::Configuration['scm_mercurial_command'] || "hg"
        HELPERS_DIR = File.dirname(__FILE__) + "/mercurial"
        HG_HELPER_EXT = "#{HELPERS_DIR}/yieldhelper.py"
        ...
        class Revision < Yield::Scm::Adapters::Revision
        ...
        def hg(*args, &block)
          ...
          full_args << '--config' << "extensions.yieldhelper=#{HG_HELPER_EXT}"
