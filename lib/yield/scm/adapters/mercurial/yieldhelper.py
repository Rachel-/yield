# yieldhelper: Yield helper extension for Mercurial
#
...
"""helper commands for Yield to reduce the number of hg calls

To test this extension, please try::

    $ hg --config extensions.yieldhelper=yieldhelper.py rhsummary
