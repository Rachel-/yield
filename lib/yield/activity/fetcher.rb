...
module Yield
  module Activity
    ...
    class Fetcher
      ...
      @@constantized_providers = Hash.new {|h,k| h[k] = Yield::Activity.providers[k].collect {|t| t.constantize } }
      ...
      def event_types
        ...
        @event_types = Yield::Activity.available_event_types
      ...
      def default_scope!
        @scope = Yield::Activity.default_event_types
      end
