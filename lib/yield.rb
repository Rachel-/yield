...
require 'yield/scm/base'
require 'yield/access_control'
require 'yield/access_keys'
require 'yield/activity'
require 'yield/activity/fetcher'
require 'yield/ciphering'
require 'yield/codeset_util'
require 'yield/field_format'
require 'yield/i18n'
require 'yield/menu_manager'
require 'yield/notifiable'
require 'yield/platform'
require 'yield/mime_type'
require 'yield/notifiable'
require 'yield/search'
require 'yield/syntax_highlighting'
require 'yield/thumbnail'
require 'yield/unified_diff'
require 'yield/utils'
require 'yield/version'
require 'yield/wiki_formatting'

require 'yield/default_data/loader'
require 'yield/helpers/calendar'
require 'yield/helpers/diff'
require 'yield/helpers/gantt'
require 'yield/helpers/time_report'
require 'yield/views/other_formats_builder'
require 'yield/views/labelled_form_builder'
require 'yield/views/builders'

require 'yield/themes'
require 'yield/hook'
require 'yield/plugin'
...
Yield::Scm::Base.add "Subversion"
Yield::Scm::Base.add "Darcs"
Yield::Scm::Base.add "Mercurial"
Yield::Scm::Base.add "Cvs"
Yield::Scm::Base.add "Bazaar"
Yield::Scm::Base.add "Git"
Yield::Scm::Base.add "Filesystem"

# Permissions
Yield::AccessControl.map do |map|
...
Yield::MenuManager.map :top_menu do |menu|
  menu.push :home, :home_path
  menu.push :my_page, { :controller => 'my', :action => 'page' }, :if => Proc.new { User.current.logged? }
  menu.push :projects, { :controller => 'projects', :action => 'index' }, :caption => :label_project_plural
  menu.push :administration, { :controller => 'admin', :action => 'index' }, :if => Proc.new { User.current.admin? }, :last => true
  menu.push :help, Yield::Info.help_url, :last => true
end

Yield::MenuManager.map :account_menu do |menu|
...
Yield::MenuManager.map :application_menu do |menu|
  # Empty
end
...
Yield::MenuManager.map :project_menu do |menu|
  ...
  menu.push :new_issue, { :controller => 'issues', :action => 'new', :copy_from => nil }, :param => :project_id, :caption => :label_issue_new,
              :html => { :accesskey => Yield::AccessKeys.key_for(:new_issue) }
...
Yield::Activity.map do |activity|
...
Yield::WikiFormatting.map do |format|
  format.register :textile, Yield::WikiFormatting::Textile::Formatter, Yield::WikiFormatting::Textile::Helper
  if Object.const_defined?(:Redcarpet)
    format.register :markdown, Yield::WikiFormatting::Markdown::Formatter, Yield::WikiFormatting::Markdown::Helper,
      :label => 'Markdown (experimental)'
  end
end

ActionView::Template.register_template_handler :rsb, Yield::Views::ApiTemplateHandler
