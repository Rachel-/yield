...
class Yield::CodesetUtilTest < ActiveSupport::TestCase
  ...
  def test_to_utf8_by_setting_from_latin1
    with_settings :repositories_encodings => 'UTF-8,ISO-8859-1' do
      ...
      assert_equal s1, Yield::CodesetUtil.to_utf8_by_setting(s2)
      assert_equal s1, Yield::CodesetUtil.to_utf8_by_setting(s3)
    end
  end
  ...
  def test_to_utf8_by_setting_blank_string
    assert_equal "",  Yield::CodesetUtil.to_utf8_by_setting("")
    assert_equal nil, Yield::CodesetUtil.to_utf8_by_setting(nil)
  end
  ...
  def test_to_utf8_by_setting_returns_ascii_as_utf8
    ...
    str1 = Yield::CodesetUtil.to_utf8_by_setting(s1)
    str2 = Yield::CodesetUtil.to_utf8_by_setting(s2)
  ...
  def test_to_utf8_by_setting_invalid_utf8_sequences_should_be_stripped
    with_settings :repositories_encodings => '' do
      ...
      str = Yield::CodesetUtil.to_utf8_by_setting(s1)
