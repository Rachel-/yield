...
class Yield::Helpers::GanttHelperTest < ActionView::TestCase
  ...
  def create_gantt(project=Project.generate!, options={})
    @project = project
    @gantt = Yield::Helpers::Gantt.new(options)
  ...
  def test_sort_issues_no_date
    ...
    Yield::Helpers::Gantt.sort_issues!(issues)
  ...
  def test_sort_issues_tree
    ...
    issue1_child1_child1_logic = Yield::Helpers::Gantt.sort_issue_logic(issue1_child1_child1)
    assert_equal [[today - 10, issue1.id], [today - 9, issue1_child1.id],
                  [today - 8, issue1_child1_child1.id]],
                 issue1_child1_child1_logic
    issue1_child1_child2_logic = Yield::Helpers::Gantt.sort_issue_logic(issue1_child1_child2)
    assert_equal [[today - 10, issue1.id], [today - 9, issue1_child1.id],
  ...
  def test_sort_versions
    ...
    assert_equal versions.sort, Yield::Helpers::Gantt.sort_versions!(versions)
  end
end
