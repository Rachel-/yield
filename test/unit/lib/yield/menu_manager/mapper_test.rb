...
class Yield::MenuManager::MapperTest < ActiveSupport::TestCase
  test "Mapper#initialize should define a root MenuNode if menu is not present in items" do
    menu_mapper = Yield::MenuManager::Mapper.new(:test_menu, {})
  ...
  test "Mapper#initialize should use existing MenuNode if present" do
    ...
    menu_mapper = Yield::MenuManager::Mapper.new(:test_menu, {:test_menu => node})
  ...
  test 'deleting all items' do
    ...
    Yield::MenuManager.map :test_menu do |menu|
      menu.push :not_last, Yield::Info.help_url
