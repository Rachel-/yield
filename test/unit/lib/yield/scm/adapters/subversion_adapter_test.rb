...
begin
  ...
  class SubversionAdapterTest < ActiveSupport::TestCase
    ...
    if repository_configured?('subversion')
      def setup
        @adapter = Yield::Scm::Adapters::SubversionAdapter.new(self.class.subversion_repository_url)
      end

      def test_client_version
        v = Yield::Scm::Adapters::SubversionAdapter.client_version
        assert v.is_a?(Array)
      end
      ...
      def test_info_nil
        adpt = Yield::Scm::Adapters::SubversionAdapter.new(
