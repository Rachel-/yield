...
begin
  ...
  class GitAdapterTest < ActiveSupport::TestCase
    ...
    if File.directory?(REPOSITORY_PATH)
      ...
      def setup
        adapter_class = Yield::Scm::Adapters::GitAdapter
        ...
        @adapter = Yield::Scm::Adapters::GitAdapter.new(
                      REPOSITORY_PATH,
                      nil,
                      nil,
                      nil,
      ...
      def test_revisions_invalid_rev
        ...
        assert_raise Yield::Scm::Adapters::CommandFailed do
          revs1 = []
          @adapter.revisions('',
                           '1234abcd',
                           "master",
      ...
      def test_annotate
        ...
        assert_kind_of Yield::Scm::Adapters::Annotate, annotate
      ...
      def test_entries_wrong_path_encoding
        adpt = Yield::Scm::Adapters::GitAdapter.new(
                      REPOSITORY_PATH,
                      nil,
                      nil,
                      nil,
      ...
      def test_path_encoding_default_utf8
        adpt1 = Yield::Scm::Adapters::GitAdapter.new(
                                  REPOSITORY_PATH
                                )
        assert_equal "UTF-8", adpt1.path_encoding
        adpt2 = Yield::Scm::Adapters::GitAdapter.new(
                                  REPOSITORY_PATH,
                                  nil,
                                  nil,
                                  nil,
