...
begin
  ...
  class MercurialAdapterTest < ActiveSupport::TestCase
    HELPERS_DIR        = Yield::Scm::Adapters::MercurialAdapter::HELPERS_DIR
    TEMPLATE_NAME      = Yield::Scm::Adapters::MercurialAdapter::TEMPLATE_NAME
    TEMPLATE_EXTENSION = Yield::Scm::Adapters::MercurialAdapter::TEMPLATE_EXTENSION
    ...
    if File.directory?(REPOSITORY_PATH)
      def setup
        adapter_class = Yield::Scm::Adapters::MercurialAdapter
        ...
        @adapter = Yield::Scm::Adapters::MercurialAdapter.new(
                              REPOSITORY_PATH,
                              nil,
                              nil,
                              nil,
      ...
      def test_info
        [REPOSITORY_PATH, REPOSITORY_PATH + "/",
          ...
          adp = Yield::Scm::Adapters::MercurialAdapter.new(repo)
      ...
      def test_path_encoding_default_utf8
        adpt1 = Yield::Scm::Adapters::MercurialAdapter.new(
                                  REPOSITORY_PATH
                                )
        assert_equal "UTF-8", adpt1.path_encoding
        adpt2 = Yield::Scm::Adapters::MercurialAdapter.new(
                                  REPOSITORY_PATH,
                                  nil,
                                  nil,
                                  nil,
