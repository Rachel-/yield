...
class Yield::Views::Builders::XmlTest < ActiveSupport::TestCase
  ...
  def assert_xml_output(expected, &block)
    builder = Yield::Views::Builders::Xml.new(ActionDispatch::TestRequest.new, ActionDispatch::TestResponse.new)
    block.call(builder)
