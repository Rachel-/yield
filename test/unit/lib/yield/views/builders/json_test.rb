...
class Yield::Views::Builders::JsonTest < ActiveSupport::TestCase
  ...
  def assert_json_output(expected, &block)
    builder = Yield::Views::Builders::Json.new(ActionDispatch::TestRequest.new, ActionDispatch::TestResponse.new)
    block.call(builder)
