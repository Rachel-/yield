...
class Yield::WikiFormatting::TextileFormatterTest < ActionView::TestCase

  def setup
    @formatter = Yield::WikiFormatting::Textile::Formatter
  end
  ...
  def test_inline_code
    assert_html_output(
      ...
      '@<Location /yield>@'    => '<code>&lt;Location /yield&gt;</code>'
    )
  end
...
Ut rhoncus elementum adipiscing."]
  ...
  def test_update_section_with_wrong_hash_should_raise_an_error
    assert_raise Yield::WikiFormatting::StaleSectionError do
