...
class Yield::WikiFormatting::MarkdownFormatterTest < ActionView::TestCase
  if Object.const_defined?(:Redcarpet)

  def setup
    @formatter = Yield::WikiFormatting::Markdown::Formatter
  end
  ...
  def test_yield_links_with_double_quotes_should_be_preserved
    text = 'This is a yield link: version:"1.0"'
