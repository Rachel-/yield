...
class Yield::Hook::ManagerTest < ActionView::TestCase
  ...
  class TestHook < Yield::Hook::ViewListener; end
  ...
  # Context: Yield::Hook::Helper.call_hook default_url
  ...
  # Context: Yield::Hook::Helper.call_hook
